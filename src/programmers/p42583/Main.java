...
//        System.out.println(new Solution2().solution(1, 1, new int[]{1, 1, 1, 1})); // 5
//        System.out.println(new Solution().solution(2, 10, new int[]{7, 4, 5, 6})); // 8
        System.out.println(new Solution2().solution(2, 10, new int[]{7, 4, 5, 6})); // 8
...
//        System.out.println(new Solution2().solution(100, 100, new int[]{10})); // 101
